...
public class FleetServiceImpl implements FleetService {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(FleetServiceImpl.class);
    ...
    public FleetServiceImpl(LocationNodeRepository locationNodeRepository,
    ...
    public Scooter rentScooter(Long scooterId) {
        ...
        if (scooter.getStatus() != ScooterStatus.AVAILABLE) {
            log.warn(
                    "Scooter rent rejected: scooterId={}, status={}",
                    scooterId,
                    scooter.getStatus()
            );
    ...
    public Scooter returnScooter(Long scooterId, Long rentalPointId) {
        ...
        if (scooter.getStatus() != ScooterStatus.RENTED
            ...
            log.warn(
                    "Scooter return rejected: scooterId={}, status={}",
                    scooterId,
                    scooter.getStatus()
            );
    ...
    public Scooter moveScooterToRentalPoint(Long scooterId,
        ...
        if (scooter.getStatus() == ScooterStatus.RENTED
            ...
            log.warn(
                    "Scooter move rejected: scooterId={}, status={}",
                    scooterId,
                    scooter.getStatus()
            );
    ...
    public Scooter requestReturnVerification(Long scooterId) {
        ...
        if (scooter.getStatus() != ScooterStatus.RENTED) {
            log.warn(
                    "Return verification rejected: scooterId={}, status={}",
                    scooterId,
                    scooter.getStatus()
            );
